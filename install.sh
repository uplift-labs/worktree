...
( cd / 2>/dev/null || true; bash "\$INSTALLER" --target "\$REPO_ROOT" --prefix "\$SANDBOX_PREFIX" \$_cc_flag \$_codex_flag \$_opencode_flag \$_opencode_permissions_flag \$_opencode_os_flag >/dev/null 2>&1 || \
