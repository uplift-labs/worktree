...
#
# Usage:
#   bash <(curl -sSL https://raw.githubusercontent.com/uplift-labs/worktree-sandbox/main/remote-install.sh) [--ref <git-ref>] [--prefix <dir>] [--with-opencode-permissions] [--with-opencode-os-sandbox]
#
